...
def createTableOld( conn, table_name, fields_names_list, fields_class,
...
def createForeignKeyOld( conn, table_name, fields_foreign_key,
                      fields_foreign_key_table ) :
    
    stmt = ""
    for field_foreign_key in fields_foreign_key :
        if fields_foreign_key[field_foreign_key] != "" :
            stmt = stmt + "ALTER TABLE `" + table_name + "` "
            stmt = stmt + "ADD CONSTRAINT `"
            stmt = stmt + fields_foreign_key[field_foreign_key]
            stmt = stmt + "` FOREIGN KEY (`" + field_foreign_key + "`) "
            stmt = stmt + "REFERENCES `"
            stmt = stmt + fields_foreign_key_table[field_foreign_key]
            stmt = stmt + "`(`" + field_foreign_key + "`); "
